    ...
    <Wrap>
      <Hero>
        ...
        <HeroInner>
          ...
          <Sub>{t("contact.subtitle", "Questions, feedback, or partnership ideas? Send a message.")}</Sub>
        </HeroInner>
      </Hero>
      ...
      <Grid>
          ...
          <Form onSubmit={onSubmit}>
            <Row>
              ...
              <Field>
                ...
                <InputWrap>
                  <PhoneIcon />
                  <Input id="phone" name="phone" inputMode="tel" placeholder="+973…" />
                </InputWrap>
              </Field>
            </Row>
            ...
            <Row>
              ...
              <Field>
                ...
                <InputWrap>
                  <TagIcon />
                  <Input id="subject" name="subject" placeholder={t("contact.subject", "Subject")} />
                </InputWrap>
              </Field>
            </Row>
            ...
            <Field>
              ...
              <TextWrap>
                <MessageIcon />
                <Textarea id="message" name="message" required placeholder={t("contact.message", "Message")} />
              </TextWrap>
              <Hint>{t("contact.response_hint", "We typically reply within 24 hours.")}</Hint>
            </Field>
        ...
        <Side>
          <Tile href="mailto:hello@oasisbook.app">
            <TileIcon><MailIcon /></TileIcon>
            <div>
              <strong>{t("contact.email_label", "Email")}</strong>
            </div>
          </Tile>
          <Tile href="https://wa.me/97300000000" target="_blank" rel="noreferrer">
            <TileIcon><WhatsIcon /></TileIcon>
            <div>
              <strong>{t("contact.whatsapp", "WhatsApp")}</strong>
            </div>
          </Tile>
          <Tile href="https://www.instagram.com/" target="_blank" rel="noreferrer">
            <TileIcon><InstaIcon /></TileIcon>
            <div>
              <strong>{t("contact.instagram", "Instagram")}</strong>
            </div>
          </Tile>
          <Tile as="a" href="/faq">
            <TileIcon><HelpIcon /></TileIcon>
            <div>
...
/* ========= styled ========= */
const Wrap = styled.section`display: grid; gap: 18px;`;
...
const HeroAccent = styled.div`
  position: absolute; inset: -40% -10% auto -10%; height: 140px;
  background: radial-gradient(70% 80% at 20% 50%, rgba(0,0,0,.06), transparent 70%),
              linear-gradient(120deg, ${({ theme }) => theme.colors.primary}, ${({ theme }) => theme.colors.primaryHover});
  opacity: .10; pointer-events: none;
`;
const HeroInner = styled.div` position: relative; padding: 22px; `;
const Title = styled.h1` margin: 0 0 6px; font-size: clamp(22px,4vw,32px); `;
...
const Side = styled.div` display: grid; gap: 10px; `;
...
const Label = styled.label` font-size: 13px; opacity: .9; `;
...
const InputWrap = styled.div`
  ...
  svg{ width: 18px; height: 18px; stroke: ${({ theme }) => theme.colors.text}; opacity:.9; justify-self: center; }
`;
const TextWrap = styled(InputWrap)` grid-template-columns: 36px 1fr; align-items: start; `;

const Input = styled.input`
  border: 0; outline: 0; background: transparent; color: ${({ theme }) => theme.colors.text};
  padding: 10px 12px;
`;
...
const Button = styled.button`
  justify-self: start; border: none; cursor: pointer; font-weight: 700;
  border-radius: 12px; padding: 10px 14px; color: #fff;
  background: ${({ theme }) => theme.colors.primary};
  transition: transform .1s ease;
  &:hover{ background: ${({ theme }) => theme.colors.primaryHover}; transform: translateY(-1px); }
  &:disabled{ opacity: .7; cursor: default; transform: none; }
`;
const Hint = styled.p` margin: 0; font-size: 12px; opacity: .75; `;
...
function CheckIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none">
      <path d="M4 12.5l5 5 11-11" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
function UserIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none">
      ...
      <path d="M4.5 19.5c1.6-3.2 5-5 7.5-5s5.9 1.8 7.5 5" strokeWidth="1.6" strokeLinecap="round"/>
    </svg>
  );
}
function PhoneIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none">
      <path d="M6 3h4l1 4-2 1a11 11 0 0 0 7 7l1-2 4 1v4a2 2 0 0 1-2 2 16 16 0 0 1-16-16 2 2 0 0 1 2-2Z" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
}
function MailIcon() {
...
function TagIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none">
      <path d="M20 13l-7 7-9-9V4h7l9 9Z" strokeWidth="1.6" strokeLinejoin="round"/>
...
function MessageIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none">
      <path d="M6 18l-2.5 3L6 20h10a4 4 0 0 0 4-4V8a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v5" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"/>
...
function HelpIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="none">
      ...
      <path d="M9.8 9.2a2.2 2.2 0 1 1 3.6 1.8c-.8.6-1.4 1.2-1.4 2.2v.4" strokeWidth="1.6" strokeLinecap="round"/>
